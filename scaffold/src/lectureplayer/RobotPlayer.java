...
public class RobotPlayer {
  ...
  public static void runExploreAndAttack(RobotController rc) throws GameActionException {
    ...
    RobotInfo[] nearbyEnemies =
        rc.senseNearbyRobots(rc.getType().getVisionRadiusSquared(), rc.getTeam().opponent());
    RobotInfo[] nearbyCats =
        rc.senseNearbyRobots(rc.getType().getVisionRadiusSquared(), Team.NEUTRAL);
