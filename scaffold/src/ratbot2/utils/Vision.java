 ...
 *
 * Units have directional vision:
 * - Baby Rat: 90° cone, sqrt(20) radius
 * - Cat: 180° cone, sqrt(30) radius
 * - Rat King: 360° (omnidirectional), sqrt(25) radius
 *
 * Standalone module - can integrate into any scaffold.
 */
public class Vision {
    ...
    /**
     * Check if target is in 90° vision cone.
     * Used by Baby Rats.
     *
    ...
    /**
     * Check if target is in 180° vision cone.
     * Used by Cats.
     *
     * @param observer Observer location
     * @param facing Direction observer is facing
     ...
     * For better performance, use getVisibleTilesIntoBuffer() with your own buffer.
     *
     * @param center Observer location
     * @param facing Direction observer is facing
     * @param radiusSquared Vision radius squared
    ...
    /**
     * Access visible tile at index from static buffer.
     * Only valid after calling getVisibleTilesCount().
     *
    ...
    /**
     * Get all tiles visible in vision cone (DEPRECATED - allocates memory).
     * Use getVisibleTilesCount() + getVisibleTile() for better performance.
     *
     * @param center Observer location
     * @param facing Direction observer is facing
     * @param radiusSquared Vision radius squared
    ...
    /**
     * Check if observer can see target given facing direction.
     * Accounts for vision cone and range.
     *
     * @param observer Observer location
    ...
    public static boolean canSee(
        MapLocation observer,
        Direction observerFacing,
        MapLocation target,
        UnitType observerType
    ) {
