 ...
 *
 * Critical for 2026: Facing direction affects:
 * - Vision (cone centered on facing)
 * - Movement cost (forward cheaper than strafing)
 * - Combat effectiveness (flanking bonus)
 *
 * Standalone module for pre-scaffold development.
 */
public class DirectionUtil {
    ...
    /**
     * Compute minimum number of turns to face target direction.
     * Each turn can rotate up to 90° (±2 direction steps).
     *
    ...
    /**
     * Get direction after turning specified amount.
    ...
    /**
     * Get optimal facing direction to see both targets.
     * Useful for multi-target awareness.
     *
    ...
    /**
     * Compute direction from vector components.
    ...
    /**
     * Get all 8 adjacent directions in optimal order (zero-allocation).
     * Order: specified direction first, then spiral outward.
     *
     * WARNING: Returns shared static buffer. Do not modify or store reference.
     * Buffer contents are overwritten on next call.
     *
    ...
    /**
     * Compute optimal movement considering facing direction.
     * Forward movement is cheaper than strafing.
     *
