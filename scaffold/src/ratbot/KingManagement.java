 ...
 *
 * Prevents multi-king losses from:
 * - Clustered kings (single cat pounce kills multiple)
 * - Lack of spatial redundancy
 * - Uncoordinated king formation
 *
 * Implements Nygard's redundancy pattern for high-availability.
 */
public class KingManagement {
    ...
    /**
     * Check if safe to form new king at this location.
     * Validates spatial distribution to prevent clustering.
     *
    ...
    /**
     * Evaluate if we should form additional king.
     * Considers:
     * - Current king count
     * - Cheese economy (can we sustain another king?)
     * - Map coverage (do we need more spawn points?)
     *
     * @param rc Robot controller
     * @return true if should consider king formation
     */
    public static boolean shouldFormAdditionalKing(RobotController rc)
        throws GameActionException {
    ...
    /**
     * Find optimal location for new king formation.
     * Maximizes spacing from existing kings and cheese mine coverage.
     *
     * @param rc Robot controller
     * @return Recommended king location, or null if none suitable
     */
    public static MapLocation findOptimalKingLocation(RobotController rc)
        throws GameActionException {
    ...
    /**
     * Calculate optimal number of kings for current game state.
     * Based on cheese income, map size, and game phase.
     *
