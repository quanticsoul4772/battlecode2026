 ...
 *
 * <p>Built on pre-developed algorithm modules: - Vision: Cone-based visibility - Pathfinding: BFS +
 * Bug2 - GameTheory: Backstab decisions - Geometry: Distance calculations - DirectionUtil: Turn
 * optimization
 */
public class RobotPlayer {

  /**
   * run() is called when a robot is instantiated. This is the main entry point for all our robots.
   */
