 ...
 *
 * Helps prevent bytecode overflows by:
 * - Tracking cumulative usage per turn
 * - Warning when approaching limit
 * - Forcing early yield if necessary
 *
 * Critical for avoiding mid-turn cutoffs.
 */
public class BytecodeBudget {
    ...
    /**
     * Reserve bytecodes for end-of-turn operations.
     * Returns true if we should skip optional operations.
     *
    ...
    /**
     * Force yield if critically low on bytecode.
    ...
    public static void logSummary(int round, int id) {
        ...
        sb.setLength(0);
        sb.append("BYTECODE:").append(round)
          .append(":").append(id)
          .append(":used=").append(used)
          .append(":remaining=").append(rem)
          .append(":percent=").append((int)pct)
    ...
    /**
     * Estimated bytecode costs for common operations.
     * Based on 2025 experience and method complexity.
     */
