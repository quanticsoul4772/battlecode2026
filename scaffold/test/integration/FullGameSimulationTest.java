...
public class FullGameSimulationTest {
    ...
    public void testBasicGameLoop() throws GameActionException {
        ...
        MockRobotController rat1 = game.addRobot(new MapLocation(15, 15), Direction.NORTH, UnitType.BABY_RAT, Team.A);
        MockRobotController rat2 = game.addRobot(new MapLocation(16, 15), Direction.NORTH, UnitType.BABY_RAT, Team.A);
