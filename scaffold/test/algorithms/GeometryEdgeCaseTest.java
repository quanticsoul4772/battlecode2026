...
public class GeometryEdgeCaseTest {
  ...
  public void testIsLineOfSightClear_DirectPath() {
    ...
    assertTrue(
        Geometry.isLineOfSightClear(new MapLocation(10, 10), new MapLocation(15, 15), passable));
  }

  @Test
  public void testLocationsWithinRadiusCount() {
    int count = Geometry.locationsWithinRadiusCount(new MapLocation(15, 15), 20, 30, 30);
    assertTrue(count > 0);
  }
}
