...
public class DirectionUtilEdgeCaseTest {
  ...
  public void testOptimalMovement_AlreadyFacing() {
    DirectionUtil.MovementPlan plan =
        DirectionUtil.optimalMovement(Direction.NORTH, Direction.NORTH);
  ...
  public void testOptimalMovement_OneTurnAway() {
    DirectionUtil.MovementPlan plan =
        DirectionUtil.optimalMovement(Direction.NORTH, Direction.NORTHEAST);
  ...
  public void testOptimalFacingForTwo() {
    Direction optimal =
        DirectionUtil.optimalFacingForTwo(
            new MapLocation(10, 10), new MapLocation(10, 15), new MapLocation(11, 15));
